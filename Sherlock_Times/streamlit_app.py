...
with tab1:
    ...
    # Quick Search
    quick_search = st.text_input("🔍 Quick Search Company (One-time)")
    if quick_search:
...
with tab2:
    ...
    # Quick Search
    quick_search_person = st.text_input("🔍 Quick Search Person (One-time)")
    if quick_search_person:
        st.subheader(f"📢 Quick Results for: {quick_search_person}")
